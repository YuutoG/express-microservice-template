const HttpStatusCodes = {
  /**
     * @description Esta respuesta provisional indica que todo hasta ahora está bien y
     * que el cliente debe continuar con la solicitud o ignorarla si ya está terminada.
  */
  CONTINUE: 100,
  /**
   * @description Este código se envía en respuesta a un encabezado de solicitud Upgrade (en-US)
   * por el cliente e indica que el servidor acepta el cambio de protocolo propuesto por el
   * agente de usuario.
   */
  SWITCHING_PROTOCOL: 101,
  /**
   * @description Este código indica que el servidor ha recibido la solicitud y aún se encuentra procesandola,
   * por lo que no hay respuesta disponible.
   */
  PROCESSING: 102,
  /**
   * @description Este código de estado está pensado principalmente para ser usado con el encabezado Link,
   * permitiendo que el agente de usuario empiece a pre-cargar recursos mientras
   * el servidor prepara una respuesta.
   */
  EARLY_HINTS: 103,
  /**
   * @description La solicitud ha tenido éxito. El significado de un éxito varía dependiendo del método HTTP.
   */
  OK: 200,
  /**
   * @description La solicitud ha tenido éxito y se ha creado un nuevo recurso como resultado de ello. Ésta es típicamente la respuesta enviada después de una petición PUT.
   */
  CREATED: 201,
  /**
   * @description La solicitud se ha recibido, pero aún no se ha actuado. Es una petición "sin compromiso",
  ...
  ACCEPTED: 202,
  /**
   * @description La petición se ha completado con éxito,
  ...
  NO_CONTENT: 204,
  /**
   * @description La petición se ha completado con éxito, pero su respuesta no tiene contenidos y además,
  ...
  RESET_CONTENT: 205,
  /**
   * @description La petición servirá parcialmente el contenido solicitado.
  ...
  PARTIAL_CONTENT: 206,
  /**
   * @description Una respuesta Multi-Estado transmite información sobre varios recursos en situaciones
  ...
  ALREDY_REPORTED: 208,
  /**
   * @description El servidor ha cumplido una petición GET para el recurso y la respuesta es una representación
  ...
  /**
   * @description Esta respuesta es enviada cuando el servidor,
  ...
  NOT_ACCEPTED: 406,
  /**
   * @description Esto es similar al código 401, pero la autenticación debe estar hecha a partir de un proxy.
   */
  PROXY_AUTHENTICATION_REQUIRED: 407,
  /**
   * @description Esta respuesta puede ser enviada cuando una petición tiene conflicto con el estado actual del servidor.
   */
  CONFLICT: 409
}
